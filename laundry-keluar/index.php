                                    ...
                                    <table class="table table-striped table-responsive">
                                        ...
                                        <tbody>
                                            <?php                                           
                                                ...
                                                $query = mysql_query("SELECT * FROM tb_laundry_keluar") or die(mysql_error());
                                                ...
                                                if(mysql_num_rows($query) == 0){                                                
                                                    ...
                                                    while($data = mysql_fetch_assoc($query)){                                                
                                                        ...
                                                        echo '<td><a href="../laundry-keluar/hapus.php?id='.$data['id_laundry'].'" onclick="return confirm(\'Yakin?\')"><span class="glyphicon glyphicon-remove" title="Hapus Data"></span></a></td>';
                                                        echo '</tr>';								                                                    
                                                    }			            		
                                                }
                                            ?>
